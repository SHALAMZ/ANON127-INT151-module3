import {
  ...
  warnDeprecation
} from "./chunk-NARTQLBC.js";
import {
  require_path
} from "./chunk-BWJKCNJV.js";
import {
  require_node_path
} from "./chunk-UHMTX7IA.js";
import {
  require_promises
} from "./chunk-7ORY44PT.js";
import {
  __toESM
...
var Identifier2 = class extends IdentifierBase {
  ...
  includeDestructuredIfNecessary(context, destructuredInitPath, init) {
    ...
    if (included ||= destructuredInitPath.length > 0 && !context.brokenFlow && propertyReadSideEffects && (propertyReadSideEffects === "always" || init.hasEffectsOnInteractionAtPath(destructuredInitPath, NODE_INTERACTION_UNKNOWN_ACCESS, createHasEffectsContext()))) {
...
var MetaProperty = class extends NodeBase {
  ...
  getReferencedFileName(outputPluginDriver) {
    ...
    if (name === IMPORT) {
      if (metaProperty2?.startsWith(FILE_OBJ_PREFIX)) {
        return outputPluginDriver.getFileName(metaProperty2.slice(FILE_OBJ_PREFIX.length));
      } else if (metaProperty2?.startsWith(FILE_PREFIX)) {
  ...
  render(code, renderOptions) {
    ...
    if (referenceId) {
      ...
      const isUrlObject = !!metaProperty2?.startsWith(FILE_OBJ_PREFIX);
  ...
  setResolution(format, accessedGlobalsByScope, preliminaryChunkId) {
    ...
    const accessedGlobals = (this.metaProperty?.startsWith(FILE_PREFIX) || this.metaProperty?.startsWith(FILE_OBJ_PREFIX) ? accessedFileUrlGlobals : accessedMetaUrlGlobals)[format];
...
var ExternalChunk = class {
  ...
  getImportAttributes(snippets) {
    return this.importAttributes ||= formatAttributes(["es", "cjs"].includes(this.options.format) && this.options.externalImportAttributes && this.moduleInfo.attributes, snippets);
  }
...
function umd(magicString, { accessedGlobals, dependencies, exports, hasDefaultExport, hasExports, id, indent: t, intro, namedExportsMode, log, outro, snippets }, { amd: amd2, compact, esModule, extend, externalLiveBindings, freeze, interop, name, generatedCode: { symbols }, globals, noConflict, reexportProtoFromExternal, strict }) {
  ...
  if ((hasExports || noConflict) && (namedExportsMode || hasExports && exports[0]?.local === "exports.default")) {
...
var AssignmentExpression = class extends NodeBase {
  ...
  include(context, includeChildrenRecursively) {
    ...
    if (includeChildrenRecursively || isConstReassignment || operator !== "=" || left.included || left.hasEffectsAsAssignmentTarget(hasEffectsContext, false) || left.hasEffectsWhenDestructuring?.(hasEffectsContext, EMPTY_PATH, right)) {
...
var UnaryExpression = class extends NodeBase {
  ...
  include(context, includeChildrenRecursively, _options) {
    if (!this.deoptimized)
      this.applyDeoptimizations();
    this.included = true;
    const shouldPreserveArgument = this.argument instanceof Identifier2 && this.argument.variable?.included;
      ...
      if (addNonNamespacesAndInteropHelpers || variable.isNamespace) {
        ...
        if (module instanceof ExternalModule) {
          ...
          if (addNonNamespacesAndInteropHelpers) {
            ...
            } else if (variable.isNamespace && namespaceInteropHelpersByInteropType[interop(module.id)] && (this.imports.has(variable) || !this.exportNamesByVariable.get(variable)?.every((name) => name[0] === "*"))) {
...
async function watchInternal(configs, emitter) {
  ...
  await loadFsEvents();
  const { Watcher } = await import("./watch-IMAIBE4A.js");
...
rollup/dist/es/shared/node-entry.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-BBT7JB3F.js.map
